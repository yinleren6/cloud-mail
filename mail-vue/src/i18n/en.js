const en = {
    ...
    reNotify: 'Re-notify',
    reNotifySuccess: 'Re-notify successful',
    reNotifyFailed: 'Re-notify failed',
    notifyInstanceName: 'Instance name (optional)',
    defaultInstanceName: 'Default',
    noNotifyInstance: 'No instances configured. Click + to add.',
    delNotifyInstanceConfirm: 'Confirm deleting this notification instance?',
    addNew: 'Add',
    editInstance: 'Edit',
    ...
    tgChatIds: 'Chat ID (comma separated)',
    tgServerUrl: 'Server URL',
    tgThreadId: 'Thread ID',
    tgSendSilently: 'Send Silently',
    tgDisableLinkPreview: 'Disable Link Preview',
    onebotApiUrl: 'API URL',
    onebotToken: 'Access Token (optional)',
    onebotTargetIds: 'Target QQ/Group ID',
    ...
    maxContentLengthDesc: 'Maximum characters for email body in notification message',
    contentTemplate: 'Content Template',
    contentTemplateDesc: 'Available variables: {subject} {from} {to} {toAddress} {content} {timestamp} {message}'
}
