const zh = {
    ...
    testFailed: '测试失败',
    reNotify: '重新通知',
    reNotifySuccess: '重新通知成功',
    reNotifyFailed: '重新通知失败',
    notifyInstanceName: '实例名称（可选）',
    defaultInstanceName: '默认',
    noNotifyInstance: '暂无实例，点击 + 添加',
    delNotifyInstanceConfirm: '确认删除该通知实例吗？',
    addNew: '添加',
    editInstance: '编辑',
    notifyTelegram: 'Telegram 通知',
    notifyOneBot: 'OneBot 通知',
    notifyWebhook: 'Webhook 通知',
    senderInfo: '发件人信息',
    show: '显示',
    hide: '隐藏',
    onlyName: '仅名称',
    ...
    tgChatIds: 'Chat ID（逗号分隔）',
    tgServerUrl: '服务器地址',
    tgThreadId: '话题 ID',
    tgSendSilently: '静默发送',
    tgDisableLinkPreview: '禁用链接预览',
    onebotApiUrl: 'API 地址',
    onebotToken: 'Access Token（可选）',
    onebotTargetIds: '目标 QQ/群 ID',
    messageType: '消息类型',
    private: '私聊',
    group: '群聊',
    notifyWeCom: '企业微信',
    ...
    maxContentLength: '内容最大长度',
    maxContentLengthDesc: '通知消息中邮件正文的最大字符数',
    contentTemplate: '消息内容模板',
    contentTemplateDesc: '可用变量: {subject} {from} {to} {toAddress} {content} {timestamp} {message}'
}
export default zh
